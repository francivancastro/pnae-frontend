...
import { FaBars, FaUserCircle, FaShoppingCart, FaLocationArrow} from 'react-icons/fa';
...
export default function NavBar() {
  ...
  return(
    <NavBarStyle className="navbar navbar-expand-lg ftco_navbar" id="ftco-navbar">
      <div className="container" >
        ...
        <div className="collapse navbar-collapse" id="ftco-nav">
          <ul className="navbar-nav">
            ...
            {signed &&
              <li className="btn  btn-default nav-item cart">
                <FaLocationArrow size={14}/><span> {user.data.city} | {user.data.district} </span> 
              </li>
            }
            ...
            {signed &&
              <li  className="btn btn-success  nav-item cart">
                <span>Saldo: R$ 5.240,50 </span>
              </li>
            }
