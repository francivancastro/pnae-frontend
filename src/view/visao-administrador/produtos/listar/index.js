...
function ListaProdutos() {
  ...
  useEffect(() => {
    ...
    async function getProdutos() {
      try {
        const response = await apiv2.get(`/products?page=${page}`)
            ...
            <table className="table table-striped table-hover text-center">
              <thead className="thead-light">
                <tr>
                  ...
                  <th scope="col">Produtor/Cooperativa</th>
              ...
              <tbody>
                {produtos.docs.map(produto => (
                  <tr key={produto._id}>
                    ...
                    <td className="align-middle" >
                      {produto.producer ? produto.producer.name
                        : produto.cooperative.name
                      }
                    </td>
                    <td className="align-middle">
                      <Link 
                        ...
                        to={{
                          pathname: "/admin/alterar/produto/" + produto._id,
                          state: produto
                        }}
